...
const Temp = () => {
  ...
  const posterDimensions = useNewbornStore((state) => state.posterDimensions);
  const setPosterDimensions = useNewbornStore(
    (state) => state.setPosterDimensions
  );
